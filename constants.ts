...
export const ABILITY_CONFIG = {
  ...
  // Wasp Abilities
  WASP_SWARM_RANGE: 8,
  WASP_SWARM_COOLDOWN: 5000, 
  WASP_MAX_CHARGES: 2, 
  WASP_MISSILES_PER_VOLLEY: 8,
  WASP_DAMAGE_PER_MISSILE: 8,
  WASP_MISSILE_DELAY: 200,
  ...
  MISSILE_ASCENT_SPEED: 40,
  MISSILE_CRUISE_SPEED: 60,
  MISSILE_TERMINAL_SPEED: 150,
